    ...
    for comp_dict in compensation_hits:
        ...
        result = email_worker(
            ...
            (
                ...
                f"for us in the past - Complex Question Creation. "
                "It looks like the task got disconnected before you could submit it. "
                f"{reason}\n"
                f"This task is only doable by you, and should reward you ${comp_dict['amount']}. Thanks for being a valued "
